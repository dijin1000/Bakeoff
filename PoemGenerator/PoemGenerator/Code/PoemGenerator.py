...
<h2 class="w3-wide">Poem Generator</h2>
<p class="w3-opacity"><i>An old silent pond</br>
A frog jumps into the pond</br>
Splash! Silence again. </br><b>- Matsuo Basho</b></i></p>
<p class="w3-justify">We are two students from the University of Leiden and we created this simple website to share the poems generated by our Poem Generator. It will nothing be like the haiku above but our computer program is taking a shot at making poems. Hopefully this will brighten your day and inspire to do great things.</p><p style="text-align:right"><i>Egon Janssen & Unkmut</i></p>
</section>
...
if(len(sys.argv) == 1 or int(sys.argv[1]) < 1):
    valid_poems = 0
    while(valid_poems < 1):
        print("A invalid or no input has given for the amount of poems of the poems. Please enter a positive number of poems should be generated:")
...
if(len(sys.argv) <= 2 or int(sys.argv[2]) < 1):
    ...
    while(valid_couplets < 1):
        print("A invalid or no input has given for the amount of couplets of the poems. Please enter a positive number of couplets a poem should contain:")
